(() => {
    ...
    (function() {
        ...
        var toggleHeader = function(direction, curScroll) {
            if (w.innerWidth > 767) {
                if (2 === direction && curScroll > 120) {
                    header.classList.add("_header-hide");
                    header.classList.remove("_header-show");
                    prevDirection = direction;
                }
                if (1 === direction && curScroll > 120) {
                    header.classList.remove("_header-hide");
                    header.classList.add("_header-show");
                }
                if (2 === direction && curScroll > 120 && header.classList.contains("_header-show")) {
                    console.log("true");
                    header.classList.remove("_header-show");
                } else if (1 === direction && curScroll < 120) {
                    header.classList.remove("_header-show");
                    prevDirection = direction;
                }
            } else {
                if (2 === direction && curScroll > 60) {
                    header.classList.add("_header-hide");
                    header.classList.remove("_header-show");
                    prevDirection = direction;
                }
                if (1 === direction && curScroll > 60) {
                    header.classList.remove("_header-hide");
                    header.classList.add("_header-show");
                } else if (1 === direction && curScroll < 60) {
                    header.classList.remove("_header-show");
                    prevDirection = direction;
                }
            }
    ...
    let numListNumbers = document.querySelectorAll(".num-list__number");
    numListNumbers.forEach(((item, index) => {
        item.innerHTML = `<span>${index + 1}</span>`;
    }));
    console.log(numListNumbers);
    window["FLS"] = true;
    isWebp();
    menuInit();
    spollers();
